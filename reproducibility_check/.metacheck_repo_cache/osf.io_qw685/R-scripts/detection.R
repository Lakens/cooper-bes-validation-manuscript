...
### Loading data - and setting up a unmarked frame for area 8 in 2017 (reference area)

# prep some data 
data <-read_xlsx("data.xlsx") # Raw data 
breaks <-c(0,25, 50, 75, 100, 125, 150, 175, 200,225,250) # distance breaks used for distance sampling 
areas <- read_xlsx("areas.xlsx") # the sampling areas
Area_year <- read_xlsx("combinations_areas_years.xlsx") # all possible combinations of years and samplingareas
...
a1_kov <- a1 %>% dplyr::select(FA,ODF) # covariats  
...
a2_kov <- a2 %>% dplyr::select(FA,ODF) # covariats  
...
a3_kov <- a3 %>% dplyr::select(FA,ODF) # covariats  
...
a4_kov <- a4 %>% dplyr::select(FA,ODF) # covariats  
...
a5_kov <- a5 %>% dplyr::select(FA,ODF) # covariats  
...
a6_kov <- a6 %>% dplyr::select(FA,ODF) # covariats  
...
a7_kov <- a7 %>% dplyr::select(FA,ODF) # covariats  
...
a8_kov <- a8 %>% dplyr::select(FA,ODF) # covariats  
...
a9_kov <- a9 %>% dplyr::select(FA,ODF) # covariats  
...
a10_kov <- a10 %>% dplyr::select(FA,ODF) # covariats  
...
a11_kov <- a11 %>% dplyr::select(FA,ODF) # covariats  
...
d1 <- distsamp(~FA~1,  umf_a1, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d2 <- distsamp(~FA~1,  umf_a2, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d3 <- distsamp(~FA~1,  umf_a3, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d4 <- distsamp(~FA~1,  umf_a4, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d5 <- distsamp(~FA~1,  umf_a5, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d6 <- distsamp(~FA~1,  umf_a6, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d7 <- distsamp(~FA~1,  umf_a7, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d8 <- distsamp(~FA~1,  umf_a8, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d9 <- distsamp(~FA~1,  umf_a9, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d10 <- distsamp(~FA~1, umf_a10, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
d11 <- distsamp(~FA~1, umf_a11, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))


c1 <- distsamp(~ODF~1,  umf_a1, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c2 <- distsamp(~ODF~1,  umf_a2, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c3 <- distsamp(~ODF~1,  umf_a3, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c4 <- distsamp(~ODF~1,  umf_a4, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c5 <- distsamp(~ODF~1,  umf_a5, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c6 <- distsamp(~ODF~1,  umf_a6, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c7 <- distsamp(~ODF~1,  umf_a7, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c8 <- distsamp(~ODF~1,  umf_a8, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c9 <- distsamp(~ODF~1,  umf_a9, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c10 <- distsamp(~ODF~1, umf_a10, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
c11 <- distsamp(~ODF~1, umf_a11, keyfun = c("halfnorm"),output = "density",unitsOut = c("kmsq"))
