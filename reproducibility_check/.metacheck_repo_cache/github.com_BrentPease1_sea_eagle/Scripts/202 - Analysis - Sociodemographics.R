...
round(prop.table(table(clean_data$age)),2) * 100

round(prop.table(table(clean_data$gender)),3) * 100

round(prop.table(table(clean_data$race)),3) * 100

round(prop.table(table(clean_data$marital_status)),3) * 100

round(prop.table(table(clean_data$employment_status)),2) * 100

round(prop.table(table(clean_data$highest_education)),2) * 100


clean_data <- clean_data %>% 
  mutate(birding_bins = cut(years_birding, breaks= c(seq(0, 75, 10))))              

round(prop.table(table(clean_data$birding_bins)),2) * 100
